...
urlpatterns = [
    ...
    path('order/<int:pk>/transfer-to-completion-production/', views.order_transfer_to_completion_production,
         name='order-transfer-to-completion-production'),
    path('order/<int:pk>/group/<int:group_id>/toggle-state/', views.group_toggle_state,
         name='group-toggle-state'),
    ...
    path('order/<int:pk>/alum-frames-report/', views.station_report, name='alum-frames-report'),
