from legacy.production_old.models import DBOrder, DBComponent
from legacy.production_old import map_db_order_to_domain, map_db_component_to_domain
from legacy.core.calculator import calculate
